...
object SparkStreamingTestRun {
  ...
  var platSet=Set("15")//PropertyUtil.getString("platIDS").split(",").toSet//properties.getProperty("platIDS").split(",").toSet
...
#kafka
192.168.124.xxx master
192.168.122.xxx slave1
192.168.121.xxx slave2
192.168.12.xxx slave3
//192.168.1.xxx windows10.microdo.cn
      */
